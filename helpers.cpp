...
vector<double> identify(const string& imagePath, 
    array<array<float, inputSize>, layer2size> w12, 
    array<array<float, layer2size>, layer3size> w23, 
    array<array<float, layer3size>, outputSize> w34, 
    vector<double> b2, 
    vector<double> b3, 
    vector<double> b4, Network network)
{

    network.reset();
    vector<double> output(outputSize, 0);
    network.input = imageToVector(imagePath, inputSize);
